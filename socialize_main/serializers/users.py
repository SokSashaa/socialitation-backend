...
class UsersSerializer(serializers.ModelSerializer):
    ...
    def get_address(self, obj):
        ...
        if (hasattr(obj, '_prefetched_observed') and
                obj._prefetched_observed
                and hasattr(obj,
                            'role_annotated') and obj.role_annotated == Roles.OBSERVED.value):  # Есть ли атрибут и не пуст ли массив
